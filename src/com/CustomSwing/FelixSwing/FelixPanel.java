...
public class FelixPanel extends JPanel {
     ...
     */
    public FelixPanel(Color color1, Color color2) {
        this.color1 = color1;
        this.color2 = color2;
        this.direction = 1;
        image = null;
     ...
     *     </ol>
     */
    public FelixPanel(Color color1, Color color2, int direction) {
        this.color1 = color1;
        this.color2 = color2;
     ...
     */
    public FelixPanel(Color color1, Color color2, int direction, BufferedImage image) {
